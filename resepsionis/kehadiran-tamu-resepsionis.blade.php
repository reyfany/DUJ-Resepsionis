                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="">
                                    <a class="nav-link menu-title" href="kehadiran-tamu-resepsionis.html"><i data-feather="users"></i><span>Tamu</span></a>
                                </li>
                        </div>
                </nav>
            </header>
                ...
                <div class="card">
                    <div class="container-fluid">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-6">
                                    <h3 style='color: #7366FF;'>Detail Data Kehadiran Tamu</h3>
                                </div>
                                <div class="col-6">
                                    <div class='boorkmark pull-right'>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Detail Data Kehadiran Tamu</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body" style="display: flex;">
                                    <div class="col-md-5">
                                        <div class="row">
                                            ...
                                            <!-- qr code end -->
                                            <!-- border -->
                                            <div class="col-md-11 pt-1" style=" border-bottom: 1px solid black;"></div> <br>
                                            <!-- border end -->
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="data-profile" style="display: flex;">
                                                    ...
                                                    <div class="isi-data col-md-7">
                                                        <p><span>:</span>&emsp;&emsp;Ikbar Ramdhani</p>
                                                    </div>
                                                </div>
                                                <div class="data-profile" style="display: flex;">
                                                    <div class="data col-md-5">
                                                ...
                                                <div class="data-profile" style="display: flex;">
                                                    ...
                                                    <div class="isi-data col-md-7">
                                                        <p><span>:</span>&emsp;&emsp;13222222221111125</p>
                                                    </div>
                                                </div>
                                                <div class="data-profile" style="display: flex;">
                                                    <div class="data col-md-5">
                                                    ...
                                                    <div class="isi-data col-md-7">
                                                        <p><span>:</span>&emsp;&emsp;20 Tahun</p>
                                                    </div>
                                                </div>
                                                <div class="data-profile" style="display: flex;">
                                                    <div class="data col-md-5">
                                                    ...
                                                    <div class="isi-data col-md-8">
                                                        <p class="text-initial"><span>:</span>&emsp;&emsp;Jalan Ahmad Yani, Kecamatan Cibinong Cikampek Kemang Jakarta Selatan </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="data-profile" style="display: flex;">
                                                    ...
                                                    <div class="isi-data col-md-7">
                                                        <p><span>:</span>&emsp;&emsp;Banyuwangi</p>
                                                    </div>
                                                </div>
                                                <div class="data-profile" style="display: flex;">
                                                    <div class="data col-md-5">
                                                    ...
                                                    <div class="isi-data col-md-7">
                                                        <p><span>:</span>&emsp;&emsp;Wirausaha</p>
                                                    </div>
                                                </div>
                                                <div class="data-profile" style="display: flex;">
                                                    <div class="data col-md-5">
                                                ...
                                                <div class="col-lg-6 " style="left: 10px;">
                                                    <a href="ubah-tamu-resepsionis.html" class="btn btn-primary btn-block" style="margin-top: 10px;">
                                                        Ubah Data</a>
                                                </div>
                                            </div>
                                            <!-- end conten detail -->
                                        ...
                                        <div id="advance-1_wrapper" class="dataTables_wrapper no-footer">
                                            <div class="header-top">
                                                <div class="faq-form pull-left">
                                                    <input class="form-control" placeholder="Cari Tamu" type="search" aria-controls="advance-1">
                                            ...
                                            <table class="table table-striped table-bordered mb-12">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="advance-1" rowspan="1" colspan="1" aria-label="Tanggal: activate to sort column ascending" style="width: 266.719px;">Tanggal</th>
                                                        <th class="sorting" tabindex="0" aria-controls="advance-1" rowspan="1" colspan="1" aria-label="Jam Kehadiran: activate to sort column ascending" style="width: 161.531ppx;">Jam Kehadiran</th>
                                                        <th class="sorting" tabindex="0" aria-controls="advance-1" rowspan="1" colspan="1" aria-label="Nama Cabang: activate to sort column ascending" style="width: 250.945px;">Nama Cabang</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
