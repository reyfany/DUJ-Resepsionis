                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="">
                                    <a class="nav-link menu-title" href="tambah-tamu-resepsionis.html"><i data-feather="users"></i><span>Tamu</span></a>
                                </li>
                        </div>
                </nav>
            </header>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="col-lg-3 ">
                                    <input type="file " class="custom-file-input id=" customFile " @change="onFileSelected " />
                                            <small class="text-danger " v-if="errors.photo "> </small>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 ">
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control " placeholder="Masukkan Alamat Center Anda * " required=" " style="height: 40px; "></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-5 ">
                                        <div class="form-group ">
                                ...
                                <div class="row ">
                                    <div class="col-lg-3 ">
                                        <a href="data-tamu-resepsionis.html" class="btn btn-primary btn-block" style="margin-top: 10px;">
                                            Simpan Data</a>
