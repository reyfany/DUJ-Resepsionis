                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="">
                                    <a class="nav-link menu-title" href="cetak-barcode-resepsionis.html"><i data-feather="users"></i><span>Tamu</span></a>
                                </li>
                        </div>
                </nav>
            </header>
                ...
                <div class="card">
                    ...
                    <div class="container-fluid">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-6">
                                    <h3 style='color: #7366FF;'>Detail Barcode</h3>
                                </div>
                                <div class="col-6">
                                    <div class='boorkmark pull-right'>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Detail Barcode</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- search -->
                    <div class="card col-md-12" style="background: none; box-shadow: none;">
                        <style>
                            .row .col-md-1 {
                                margin: 0.5rem;
                            }
