                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="">
                                    <a class="nav-link menu-title" href="ubah-profile.html"><i data-feather="user"></i><span>Profile</span></a>
                                </li>
                        </div>
                </nav>
            </header>
                ...
                <div class="card">
                    ...
                    <div class="container-fluid">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-6">
                                    <h3 style='color: #7366FF;'>Ubah Data Profile</h3>
                                </div>
                                <div class="col-6">
                                    <div class='boorkmark pull-right'>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Ubah Data Profile</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            ...
                            <div class="row ">
                                <div class="col-lg-3 ">
                                    <a href="detail-profile.html " class="btn btn-primary btn-block " style="margin-top: 10px; ">
                                        Simpan Data</a>
                                </div>
                            </div>
                        </form>
